...
pairA = input('To confirm, please enter your currency choice again.  it...'+'')
pairB = 'USD'
...
#########################################################################################
    ...
    for ll in range(0,4):# Calculate the past 4 values from coppock using a weighted moving Average.
    ...
    coppockD1 = numpy.zeros(3)# Calculate last 3 derivatives from coppock.
    for mm in range(3):
...
##################################################################
    ...
    if firstTrade == True and (sellingPower * currentPrice > 5) and signal == True and trade == True and (currentPrice > startPrice):
        ...
        print(iteration,'sell!',timestamp, currentPrice, sellingPower, buyingPower)
    print(timestamp, firstTrade, signal, '|',buy, sell,'|', currentPrice, sellingPower, buyingPower)
